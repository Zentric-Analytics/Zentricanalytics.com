...
const permissionKeysByRole = {
  ...
  EMPLOYEE: ["employee.read_self", "employee.update_self", "leave.request", "leave.read_self", "time.capture_self", "time.read_self", "time.correction.request", "time.timesheet.submit", "document.read_self", "asset.read_self", "workflow.task.complete"],
};
