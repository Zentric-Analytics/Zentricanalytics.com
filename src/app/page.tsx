...
import { ClientChoiceTimeline } from '@/components/ClientChoiceTimeline';

export const metadata: Metadata = {
  title: 'Software, AI & Data Engineering',
  description: 'Zentric Analytics builds secure, scalable software, AI, data, and cloud systems for organizations tackling serious technology challenges.',
  alternates: { canonical: '/' },
  openGraph: {
    title: 'Software, AI & Data Engineering | Zentric Analytics',
    description: 'Engineering reliable software, AI, data, and cloud systems for serious work.',
    url: '/',
    type: 'website',
    images: [{ url: '/images/hero/hero-engineering-team-v2.webp', width: 1536, height: 1024, alt: 'Zentric Analytics engineers collaborating' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Software, AI & Data Engineering | Zentric Analytics',
    description: 'Engineering reliable software, AI, data, and cloud systems for serious work.',
    images: ['/images/hero/hero-engineering-team-v2.webp'],
  },
};
      ...
      <section className="core-capabilities-section border-t border-[#DCE3EA] bg-[#F3F6F9] px-4 pb-2 pt-3 sm:px-6 sm:py-9 lg:py-10" aria-labelledby="core-capabilities-heading">
        <ScrollReveal>
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-4 grid gap-x-12 sm:mt-6 sm:grid-cols-2 lg:gap-x-16">
              {capabilities.map((capability, index) => (
                <div
                  className="industries-child-reveal group flex items-center gap-3.5 border-b border-[#DCE3EA] py-2.5 text-left transition-colors duration-200 ease-out last:border-b-0 sm:py-3 sm:[&:nth-last-child(-n+2)]:border-b-0"
