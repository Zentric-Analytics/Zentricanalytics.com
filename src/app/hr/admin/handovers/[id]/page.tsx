  ...
  return <main className="space-y-7">
    ...
    <div className="grid gap-5 xl:grid-cols-2">
      ...
      <section className="rounded-2xl border bg-white p-5"><h2 className="text-xl font-bold">Handover controls</h2><div className="mt-3 space-y-3">
        ...
        {handover.status === "APPROVED" && !handover.conversion && application.status === "Hired" ? <HandoverActionForm label="Connect completed recruitment onboarding"><input type="hidden" name="operation" value="CONVERT" /><input type="hidden" name="handoverId" value={handover.id} /></HandoverActionForm> : null}
        {!handover.conversion && <p className="mt-3 text-sm">Complete HR review through the linked recruitment stages. Final approval connects the completed onboarding record; it does not start another applicant checklist.</p>}
