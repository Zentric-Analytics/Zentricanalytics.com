    ...
    <PageShell>
      <section className="za-container za-section-compact">
        ...
        <div className="min-w-0 break-words text-slate-700">
          <Stagger className="grid border-y border-[#DCE3EA] md:grid-cols-2" staggerDelay={100}>
            {aboutCards.map((card) => (
              <article className="border-b border-[#DCE3EA] p-6 transition-colors duration-200 hover:bg-[#F8FAFC] md:[&:nth-child(n+3)]:border-b-0 md:odd:border-r" key={card.title}>
