...
if (!/^unit6_restore(?:_|$)|^zentric_unit(?:4_restore_|5_restore(?:_|$)|6_restore(?:_|$)|7_restore(?:_|$)|8_restore(?:_|$))/.test(target.pathname.slice(1))) blocked("The target database must use an isolated Unit 4 through Unit 8 restore naming convention.");
