          ...
          >
            ...
            >
              ...
              <span className="min-w-0">
                <span className="block text-lg font-bold leading-[1.3] tracking-[-0.025em] text-[#0B1F3A] transition-colors duration-[275ms] ease-out group-hover:text-[#0B7F60] group-focus-within:text-[#0B7F60] sm:text-xl lg:text-2xl">
                  {title}
                </span>
                <span
                  id={descriptionId}
                ...
                >
                  <span className="mt-1.5 block text-sm leading-[1.6] text-[#475569] sm:text-base">
                    {description}
                  </span>
                </span>
              </span>
