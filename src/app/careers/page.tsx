    ...
    <PageShell>
      ...
      <section className="relative z-20 -mt-5 rounded-t-[32px] bg-white px-4 pb-12 pt-10 sm:-mt-7 sm:rounded-t-[44px] sm:px-6 sm:pt-12 lg:-mt-8 lg:rounded-t-[56px] lg:px-8 lg:pb-16 lg:pt-14" aria-labelledby="open-roles-heading">
        <div className="mx-auto max-w-6xl">
            ...
            <Stagger className="mx-auto mt-8 grid max-w-[22rem] gap-x-4 gap-y-5 sm:max-w-[54rem] sm:grid-cols-2 lg:mt-10 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-6" delay={120} staggerDelay={90}>
              {roles.map(({ Icon, title, description }) => (
                <article
                  key={title}
                  className="group flex min-h-[13rem] min-w-0 flex-col rounded-[22px] border border-[#E3EAF1] bg-white p-5 text-left shadow-[0_18px_42px_rgba(15,23,42,0.06)] transition duration-200 ease-out motion-safe:hover:-translate-y-0.5 hover:border-[#D4DEE8] hover:shadow-[0_20px_46px_rgba(15,23,42,0.08)] sm:min-h-[13.5rem] sm:rounded-[24px] sm:p-6 lg:p-[26px]"
                >
