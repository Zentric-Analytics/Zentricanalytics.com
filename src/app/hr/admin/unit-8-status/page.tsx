...
const items = [
  ["Environment", production ? "Production — controlled Unit 8 release" : "Staging validation — production untouched"],
  ["Branch", production ? "main" : "dev"],
  ["HEAD SHA", head],
  ["Validated deployment", production ? "Current Render production deployment; exact ID recorded in the release report" : "dep-d9vgp7942hec73918hmg"],
  ["Tests", "771/771 passing across 69 files; TypeScript, ESLint, Prisma and production build pass"],
  ["Migrations", production ? "51/51 applied to the production database; none pending" : "51/51 applied to zentric_analytics_staging; none pending"],
  ...
  ["Encrypted archive", production ? "PASS — encrypted pre-release production archive 9df141e6336e created and remotely verified" : "PASS — durable archive ba3853c31247; checksum and remote object version verified"],
