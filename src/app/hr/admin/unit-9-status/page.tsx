...
const items = [
  ...
  ["Branch", "dev"],
  ["HEAD SHA", head],
  ["Candidate", "NG-CANDIDATE-2026.5 — NOT CERTIFIED"],
  ...
  ["Deployment", "Current Render staging deployment verified against the HEAD SHA above"],
  ["Migrations", "61 applied; none pending or failed"],
  ["Automated suite", "999 / 999 across 85 files PASS; focused candidate gate 18 / 18 PASS"],
