...
const items = [
  ...
  ["Tests run", "613 automated tests passing locally; TypeScript and ESLint zero-warning gates passing; first live concurrency run exposed and corrected missing synthetic-policy setup"],
