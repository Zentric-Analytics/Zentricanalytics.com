...
export const HR_PERMISSIONS = [
  ...
  "asset.manage", "asset.assign", "asset.return", "asset.read_self", "workflow.create", "workflow.assign", "workflow.review", "workflow.override",
...
const rolePermissions: Record<HrRoleKey, readonly HrPermissionKey[]> = {
  ...
  PAYROLL_ADMIN: HR_PERMISSIONS.filter((permission) => permission.startsWith("payroll.") || permission === "employee.read_all"),
